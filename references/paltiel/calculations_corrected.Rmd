...
test.sensitivity <- 0 #0.8  # true positive
test.cost <- 25
test.specificity <- 1 #0.98 # true negative
...
df <- 
  ...
  mutate(`New Infections` = lag(Asympt,1,NA)*beta*lag(Susceptible,1,NA)/(total.n),
         ...
         `Cumulative Infections` = cumsum(`New Infections`)+initial.infected,
